...
//Lib.trace( "AGALMiniAssembler.assemble time: " + ( ( getTimer() - start ) / 1000 ) + "s" );
	...
	inline function get_error():String {
		return _error;
	}

	inline function get_agalcode():ByteArray {
		return _agalcode;
	}
...
// Fill the dictionaries with opcodes and registers
	...
	static var OPMAP:StringMap<OpCode> = new StringMap<OpCode>();
	static var REGMAP:StringMap<Register> = new StringMap<Register>();
	static var SAMPLEMAP:StringMap<Sampler> = new StringMap<Sampler>();

	static var MAX_NESTING:Int = 4;
	static var MAX_OPCODES:Int = 200;

	static var FRAGMENT:String = "fragment";
	static var VERTEX:String = "vertex";

// masks and shifts
	static var SAMPLER_TYPE_SHIFT:UInt = 8;
	static var SAMPLER_DIM_SHIFT:UInt = 12;
	static var SAMPLER_SPECIAL_SHIFT:UInt = 16;
	static var SAMPLER_REPEAT_SHIFT:UInt = 20;
	static var SAMPLER_MIPMAP_SHIFT:UInt = 24;
	static var SAMPLER_FILTER_SHIFT:UInt = 28;

// regmap flags
	static var REG_WRITE:UInt = 0x1;
	static var REG_READ:UInt = 0x2;
	static var REG_FRAG:UInt = 0x20;
	static var REG_VERT:UInt = 0x40;

// opmap flags
	static var OP_SCALAR:UInt = 0x1;
	static var OP_INC_NEST:UInt = 0x2;
	static var OP_DEC_NEST:UInt = 0x4;
	static var OP_SPECIAL_TEX:UInt = 0x8;
	static var OP_SPECIAL_MATRIX:UInt = 0x10;
	static var OP_FRAG_ONLY:UInt = 0x20;
	static var OP_VERT_ONLY:UInt = 0x40;
	static var OP_NO_DEST:UInt = 0x80;
	static var OP_VERSION2:UInt = 0x100;
	static var OP_INCNEST:UInt = 0x200;
	static var OP_DECNEST:UInt = 0x400;
...
// opcodes
	...
	static inline var IFZ:String = "ifz";
	static inline var INZ:String = "inz";
	...
	static inline var IEG:String = "ieg";
	static inline var IEL:String = "iel";
	static inline var ELS:String = "els";
	static inline var EIF:String = "eif";
	static inline var REP:String = "rep";
	static inline var ERP:String = "erp";
	static inline var BRK:String = "brk";
...
// samplers
	...
	static var RGBA:String = "rgba";
	static var DXT1:String = "dxt1";
	static var DXT5:String = "dxt5";
